package com.example.finemaps.nms.v1_17_R1;
...
/**
 * NMS adapter for Minecraft 1.17.1.
 */
public class NMS_v1_17_R1 implements NMSAdapter {

    private final Logger logger;

    public NMS_v1_17_R1(Logger logger) {
        this.logger = logger;
    }

    @Override public String getVersion() { return "v1_17_R1"; }
    ...
    @Override public int getMajorVersion() { return 17; }
