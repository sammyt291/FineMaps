package com.example.mapdb.nms.v1_16_R3;
...
/**
 * NMS adapter for Minecraft 1.16.5.
 */
public class NMS_v1_16_R3 implements NMSAdapter {

    private final Logger logger;

    public NMS_v1_16_R3(Logger logger) {
        this.logger = logger;
    }
    ...
    @Override
    public int spawnMapDisplay(Location location, int mapId) { return -1; }

    @Override
    public void removeDisplay(int entityId) {}

    @Override
    public boolean supportsBlockDisplays() { return false; }
    ...
    @Override
    public boolean supportsFolia() { return false; }

    @Override
    public int getMajorVersion() { return 16; }
