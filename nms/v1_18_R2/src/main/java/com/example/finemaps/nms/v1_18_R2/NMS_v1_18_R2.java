package com.example.finemaps.nms.v1_18_R2;
...
/**
 * NMS adapter for Minecraft 1.18.2.
 */
public class NMS_v1_18_R2 implements NMSAdapter {

    private final Logger logger;

    public NMS_v1_18_R2(Logger logger) {
        this.logger = logger;
    }

    @Override public String getVersion() { return "v1_18_R2"; }
    ...
    @Override public int getMajorVersion() { return 18; }
